This landscape I want to use in the login page for [[☀️Sol Industrial Energy]].
Идеята е да зелено поле с чисто небе и пухкави облаци. Да се виждат планини в далечината. Да има вятърни мелници, соларни панели и балони във въздуха. Това е и перфектен начин да тренирам за [[Game development]]. И за играчката да направя във всеки сезон как да изглежда:
...
Критерий: 
- Да се рендерира в най-сисокото възможа резолюция
- Да се направи видео в няколко формата
	- 4к
	- gif
- Самия рендър да се разхожда из цнената тип GTA където те разхожда и после отива на следващия обект да го гледа.
	- Отдалече цялата сцена (Най-дългото)
	- По край панелите и тревата
	- По край фабриката
...
https://www.artstation.com/artwork/aoXoG8


![[Pasted image 20260310104521.png]]
```embed
title: "Green Evolution - Urban design , ArquiTravelDesign"
image: "https://cdna.artstation.com/p/assets/images/images/087/383/674/large/arquitraveldesign-ubm2.jpg?1745632533"
description: "URBAN INTERVENTION PROJECT - GREEN EVOLUTION - 🌲🌳🍀⭐UNA FUSION OF NATURE AND TECHNOLOGY⭐⭐⭐⭐⭐🏞️ A year of dedication, effort and time to share the first phase of this wonderful project dedicated and sponsored by some of the most influential environmental and ecological companies on the island of Malta, a central Mediterranean archipelago located between Sicily and the coast of North Africa.  Delimara, famous for its spectacular scenery, is a unique coastal treasure with an excellent fishing village vibe, is the protagonist of projecting the wonderful ecological park project with 890,520,000 M2 grouped and subdivided into 7 sectors strategically selected to maintain the culture, and the new green lung of the island with large amounts of vegetation, and perfect open spaces.  *Sector A 📆🪄 : Events and Conservation This sector could host cultural festivals and community fairs, promoting social interaction and tradition. It would also include an area dedicated to biodiversity conservation, with gardens displaying native Mediterranean flora and educational spaces for environmental workshops.  *Sector B🚎🚐: Sustainable Mobility and Community Services This sector is designed as a key hub for mobility and integrated services that promote sustainability and community wellbeing with technology and biodiversity Electric Bus Terminal: A modern station equipped to operate exclusively with electric buses, promoting an environmentally friendly transportation system. It would feature fast charging areas, comfortable waiting areas for passengers, and an accessible design that prioritizes efficiency and connectivity with other sectors of the urban design. Motorhome parking: An area for parking and services for motorhomes, equipped with electrical connection points, water supply, and waste management stations. This space is designed to promote itinerant tourism, offering visitors a comfortable and functional place to park while exploring the rest of the urban project.  *Sector C🎑🛟⛵ : Luxury Hotel, Events and Entertainment This sector could become an iconic attraction point, focused on offering a sophisticated and memorable experience. The addition of a five-star luxury hotel would stand out for its elegant architectural design, complemented by indoor and outdoor spaces that balance comfort and aesthetics. Weddings and celebrations: A modern yet traditional chapel for romantic ceremonies could be included, as well as a specialized event planning team to ensure a personalized and unique experience for guests. Water park: This space would be complemented by a themed water park, suitable for all ages. Attractions would include water slides, wave pools and interactive areas for children, designed with safety and fun as a priority.  *Sector D🏕️🏝️⚽🏀🥅🤿: Sports and Recreation A multifunctional space for outdoor sports and recreational activities, suitable for cycling, skydiving, hiking and extreme sports spaces. Could include circuits designed to reflect natural landscapes and skateboarding areas that match the aesthetics of the surrounding environment.  *Sector E🛡️🔰💡🔌🔋: Alternative Energies A sector dedicated to sustainability, focused on showcasing the most advanced technologies in renewable energy, such as solar panels and wind turbines. This space could also include interactive and educational installations to raise awareness of the impact of clean energy.  *Sector F🎀🎏🎁🎊🏮: Culture and Events Annual hot air balloon events, museum celebrating maritime history and heritage, complemented by a versatile space for musical, artistic and community events. Marine museums, tree houses along with different activities that highlight local traditions, making this sector a central point of cultural expression.  *Sector G✳️〽️⛺🌹🌼: Conservation and Biodiversity An area dedicated to environmental protection, with interpretive trails that allow visitors to explore and learn about the importance of biodiversity in a Mediterranean environment. It includes rest areas surrounded by vegetation and educational points to encourage a harmonious relationship with nature."
url: "https://www.artstation.com/artwork/oJK0Pk"
favicon: ""
...
Game like 
```embed
title: "Stylized UE4 Landscape, Jasmin Habezai-Fekri"
image: "https://cdna.artstation.com/p/assets/covers/images/030/759/446/large/jasmin-habezai-fekri-jasmin-habezai-fekri-landscape1.jpg?1601562339"
description: "Ahead of the Bird House project: https://www.artstation.com/artwork/mDW6Yd I wanted to create a landscape inside Unreal Engine 4, helping me to learn the Engine and implementing all the tech and shaders that would be needed to create a stylized environment.   My goal was to achieve a 2D/Ghibli-esque look to the grass and shading, meaning that the grass on the landscape is shadeless while the trees and rocks cast shadows. The rocks and flowers are reused from my Library Project.  For the landscape material, I created several layers, which gave me the possibility to paint in the shades of the grass and have 2 dirt variations, with the blending having a painterly look to it as well. Everything makes use of the Runtime Virtual Texturing material set up.  The lighting is very simple: a Skylight, one sunny directional light casting shadows and one cool directional light (no shadows casting) brightening up the shadows. "
url: "https://www.artstation.com/artwork/yk4PbQ"
favicon: ""
...
image: "https://cdnb.artstation.com/p/assets/covers/images/019/529/817/large/jessica-woulfe-image.jpg?1563900765"
description: "My submission for the Atomhawk solarpunk contest (a future powered by green energy). Honoured to win the grand prize! :)  The year is 2060. The government subsidizes farmers to allow wind turbines to fly above their farms, while still allowing use of the land for crops and livestock. This scene depicts a generations-old traditional norwegian farmhouse, with the farmer and his daughter going about their life on the farm. While he represents the past and tradition, his daughter represents the future (she is wearing white, he is wearing traditional farmers clothing). This story moment represents tradition accepting the future (holding hands with), the next generation."
url: "https://www.artstation.com/artwork/3oQnvD"
favicon: ""
aspectRatio: "100"
```
